# -*- coding: utf-8 -*-
"""
Created on Mon May  6 20:47:27 2019
...
X_train_orig, Y_train_orig, X_test_orig, Y_test_orig = load_dataset_mnist()
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.009, num_epochs = 500, minibatch_size = 32, print_cost = True):
    """
...
#        saver.restore(sess, "C:\\Users\\feder\\Documents\\DiplomadodeepLearning\\clase6-5-2019\\model_softmax_mnist.ckpt")        
#        print("Model restored.") 
        ...
        for epoch in range(num_epochs):
            ...
            if print_cost == True and epoch % 10 == 0:
                ...
                save_path = saver.save(sess, "C:\\Users\\feder\\Documents\\DiplomadodeepLearning\\clase6-5-2019\\model_softmax_mnist.ckpt") 
...
def model_predict(data_test, y_label, learning_rate = 0.009, num_epochs = 100, minibatch_size = 10, print_cost = True):
    ...
    tf.set_random_seed(1)                             #  (tensorflow seed)
    seed = 3         
#    (n_H0, n_W0, n_C0) = data_test.shape     
...
#img = cv2.imread("C:\\Users\\feder\\Documents\\DiplomadodeepLearning\\clase_4-5-2019\\RedesConvolucionales_Clase1_empty\\3.jpg")
